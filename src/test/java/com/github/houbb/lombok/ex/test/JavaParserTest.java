...
//            SourceRoot sourceRoot = new SourceRoot(CodeGenerationUtils.mavenModuleRoot(JavaParserTest.class).resolve("src/main/resources"));
//
...
//                    CodeGenerationUtils.mavenModuleRoot(JavaParserTest.class)
